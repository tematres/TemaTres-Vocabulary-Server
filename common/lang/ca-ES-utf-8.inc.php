...
define("FORM", "Form") ;
define("ERROR", "Error") ;
define("LABEL_bienvenida", "Benvinguts a TemaTres Vocabulary Server") ;
// COMMON SQL
...
define('LABEL_enable', "habilitat");  /* web services status info: in use */
define('LABEL_disable', "no habilitat");  /* web services status info: not in use */
...
define('LABEL_update1_1x1_2', "Actualitzar (1.1 -> 1.3)");
define('LABEL_update1x1_2', "Actualitzar (1.0x -> 1.3)");
...
define('LABEL_update1_3x1_4', "Actualitzar (1.3x -> 1.4)");
...
define('LABEL_mail_recovery_pass2', 'Nom d\'usuari: %s');
...
## v1.8
define('LABEL__getForRecomendation', 'cercar recomanacions');
define('LABEL__getForRecomendationFor', 'cercar recomanacions per a ');
define('FORM_LABEL__contactMail', 'Correu electrònic de contacte');
define('LABEL_addMapLink', 'agregar mapatge entre vocabularis');
define('LABEL_addExactLink', 'agregar enllaç de referència');
define('LABEL_addSourceNote', 'agregar nota de font');
## v1.82
define('LABEL_FORM_mappedTermReport', 'Relacions entre vocabularis');
define('LABEL_eliminar', 'Eliminar');
##v.2
define('MSG_termsNoDeleted', 'termes no van ser eliminats');
define('MSG_termsDeleted', 'termes eliminats');
define('LABEL_selectAll', 'seleccionar tot');
define('LABEL_metadatos', 'metadades');
define('LABEL_totalTermsDescendants', 'termes descendents');
define('LABEL_altTerms', 'termes alternatius');
define('LABEL_narrowerTerms', 'termes específics');
define('LABEL_results', 'resultats');
define('LABEL_showFreeTerms', 'llista de termes lliures');
define('LABEL_helpSearchFreeTerms', 'Només es cercaran termes lliures.');
define('LABEL_broatherTerms', 'termes genèrics');
define('LABEL_type2filter', 'tecleji per a filtrar termes');
define('LABEL_defaultEQmap', 'Utilitzi "eq" per a indicar relació d\'equivalència');
define("MSG_repass_error", "les claus no coincideixen");
define("MSG_lengh_error", "mínim de %d caràcters");
define("MSG_errorPostData", "Ha ocorregut una errada, si-us-plau revisi les dades corresponents al camp ");
define('LABEL_preferedTerms', 'termes preferits');   /* Descriptor */
define('LABEL_FORM_NULLnotesTermReport', 'termes SENSE notes');
define('MSG_FORM_NULLnotesTermReport', 'termes que no tenen notes de tipus');
define('LABELnoNotes', 'termes sense ninguna nota');
...
define('LABEL_addTargetVocabulary', 'agregar vocabularis de referència(serveis web terminològics)');
#v.2.1
define('LABEL_duplicatedTerm', 'terme duplicat');
define('LABEL_duplicatedTerms', 'termes duplicats');
define('MSG_duplicatedTerms', 'La configuració del vocabulari no permet termes duplicats.');
define('LABEL_bulkReplace', 'canvis globals(cercar i reemplaçar)');
define('LABEL_searchFor', 'Text a cercar');
define('LABEL_replaceWith', 'reemplaçar amb');
define('LABEL_bulkNotesWillReplace', 'notes es modificaran');
define('LABEL_bulkNotesReplaced', 'notes van ser modificades');
define('LABEL_bulkTermsWillReplace', 'termes es modificaran');
define('LABEL_bulkTermsReplaced', 'termes van ser modificats');
define('LABEL_termMOD', 'termes modificats');
define('LABEL_noteMOD', 'nota modificada');
define('MENU_bulkEdition', 'canvis globals');
define('MSG_searchFor', 'text que desitja cercar(sensible a majúscules)');
define('MSG_replaceWith', 'text que reemplaçarà(sensible a majúscules)');
define('LABEL_warningBulkEditor', 'Vostè va a modificar massivamente dades ¡Aquestes accions són IRREVERSIBLES!');
define('LABEL_CFG_SUGGESTxWORD', 's\'han de suggerir termes segons paraules o frases?');
define('LABEL_ALLOW_DUPLICATED', 'es permeten termes duplicats?');
define('LABEL_CFG_PUBLISH', 'el vocabulari pot ser consultat per qualsevol?');
define('LABEL_Replace', 'reemplaçar');
define('LABEL_Preview', 'vista prèvia');
#v.2.2
define('LABEL_selectRelation', 'seleccionar relació');
define('LABEL_withSelected', 'amb els seleccionats:');
define('LABEL_rejectTerms', 'rebutjar termes');
define('LABEL_doMetaTerm', 'convertir en meta-termes');
define('LABEL_associateFreeTerms', 'vincular com a UF, TE o TR');
define('MSG_associateFreeTerms', 'en el següent pas podrà seleccionar el tipus de relació.');
define('MSG_termsSuccessTask', 'termes afectats en l\'operació');
define('LABEL_TTTerms', 'termes top');
define('MSG__GLOSSincludeAltLabel', 'incluir termes alternatius');
define('MSG__GLOSSdocumentationJSON', 'La font JSON del glossari pot ser integrada amb qualsevol contingut HTML utilizant la llibreria <a href="https://github.com/PebbleRoad/glossarizer" target="_blank" title="Glossarizer">Glossarizer</a>');
define('LABEL_configGlossary', 'exportar font de dades per a glossari');
define('MSG_includeNotes', 'utilitzar notes de tipus:');
define('LABEL_SHOW_RANDOM_TERM', 'presentar en la pàgina d\'inici un terme seleccionat a l\'atzar. S\'ha de seleccionar un tipus de nota.');
define('LABEL_opt_show_rando_term', 'presentar termes amb nota:');
define('MSG_helpNoteEditor', 'Pot vincular termes utilitzant claudàtors dobles. Ex: Només l\'[[amor]] salvarà el món');
define('LABEL_GLOSS_NOTES', 'Seleccionar tipus de nota per a glossar termes marcats amb claudàtors dobles: [[glossari]]');
...
define('LABEL_AlphaPDF', 'Alfabètic(PDF)');
define('LABEL_SystPDF', 'Sistemàtic(PDF)');
define('LABEL_references', 'referències');
define('LABEL_printData', 'data d\'impressió');
##v.3
define('MENU_bulkTranslate', 'editor multilingüe');
define('LABEL_bulkTranslate', 'editor de traduccions i equivalències');
define('LABEL_termsEQ', 'amb correspondències');
define('LABEL_termsNoEQ', 'sense correspondències');
define('LABEL_close', 'tancar');
...
define('LABEL_rel_associative', 'relacions associatives');
define('LABEL_rel_hierarchical', 'relacions jeràrquiques');
define('LABEL_rel_synonymy', 'relacions de sinonimia');
define('LABEL_prototypeTerms', 'termes centrals');
define('LABEL_copy_click', 'copiar terme al portapapers');
define('LABEL__ENABLE_COPY_CLICK', 'Habilitar botó per a copiar termes al portapapers.');
#v.3.2
define('LABEL_order', 'ordre');
define('LABEL_alias', 'alies');
define('LEGEND_alias', 'consigni un alies breu');
define('LABEL_src_note', 'font');
