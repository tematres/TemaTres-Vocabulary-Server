...
$install_message[201] = "No se encuentra el archivo de configuración de la base de datos (/include/db.tematres.php) hay archivo." ;
$install_message[202] = "Archivo de configuración de la base de datos encontrado." ;
$install_message[203] = "No es posible conectar con el servidor <em>%s</em> utilizando el usuario <em>%s</em>. Por favor revise los datos del archivo de configuración de la base de datos (/include/db.tematres.php)" ;
$install_message[204] = "Conexión con el servidor <em>%s</em> exitosa" ;
$install_message[205] = "No es posible conectar con la base de datos <em>%s</em> en <em>%s</em>. Por favor revise los datos del archivo de configuración de la base de datos (/include/db.tematres.php)." ;
