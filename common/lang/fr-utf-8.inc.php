...
define('LABEL__ENABLE_SPARQL', 'Activer SPARQL.<br>Pour la mise à jour du serveur, visitez la page Menu&nbsp;> Administration&nbsp;> Base de données&nbsp;> MAJ serveur SPARQL');
...
define('LABEL_AgregarRTexist', 'Rechercher le terme à associen à ');
...
define('LABEL_helpSearchFreeTerms', 'Seulement les termes libres');
...
define('LABEL_searchFor', 'Recherche');
...
#v.2.2
define('LABEL_selectRelation', 'Type de relation');
...
define('MSG__autoGlossInfo', 'Les termes du vocabulaire apparaissant dans les notes vont être transformés en [[hyperliens]] pointant vers la fiche du terme en question.<br>Note&nbsp;: la recherche est sensible à la casse.');
