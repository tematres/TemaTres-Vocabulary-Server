...
define("LABEL_AgregarTG", "Subordinar %s a termo superior ");
...
define("FORM_LABEL_TerminosUP", "termos equivalentes");
...
define("FORM", "Form") ;
define("ERROR", "Error") ;
define("LABEL_bienvenida", "Bienvenido a TemaTres Vocabulary Server") ;
// COMMON SQL
...
define('LABEL_disable', "non habilitado");  /* web services status info: not in use */
...
define('MSG_check_mail_link', 'Si la dirección de correo consignada es correcta, por favor revisa tu correo electrónico para obtener el enlace de confirmación.');
