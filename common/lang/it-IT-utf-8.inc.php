...
define("TE_termino", "Termine più specifico");
define("TG_termino", "Termine più generico");
...
define("MENU_AgregarTG", "Termine più generico (BT)");
define("MENU_AgregarTE", "Termine più specifico (NT)");
define("MENU_AgregarTR", "Termine associato (RT)");
define("MENU_AgregarUP", "Termine alternativo (UF)");  /* Non-descriptor */
define("MENU_MisDatos", "Il mio accesso");
define("MENU_Caducar", "Disabilita");
define("MENU_Habilitar", "abilitato");
...
define("LABEL_AgregarTG", "Aggiungi termine più generico a %s ");
define("LABEL_AgregarTE", "Nuovo termine più specifico di ");
...
define("FORM_LABEL_TerminosUP", "termini non preferiti");
...
define("LABEL_NO_vocabulario_referencia", "non c'è un vocabolario di supporto per impostare la relazione fra termini");
...
// COMMON SQL
define("PARAM_SERVER", "Indirizzo del server") ;
define("PARAM_DBName", "Nome del database") ;
...
define('LABEL_ProfundidadTermino', "è collocato ad un lilvello più basso");
...
define("IMPORT_do_it", "È possibile iniziare l'importazione") ;
...
define('LABEL_poliBT', 'più di un termine generico');
...
define('IMPORT_skos_file_already_exists', 'La fonte Skos-Core è nel server');
...
define('LABEL_CFG_MAX_TREE_DEEP', 'Massimo livello di profondità nell\'albero di elementi da visualizzare nella stessa pagina');
...
define('LABEL_user_recovery_password1', 'Digitare nome utente o indirizzo email. Si riceverà un link per creare una nuova password via email.');
...
define('LABEL_mail_pass3', 'Si può modificare.');
...
define('MSG__warningDeleteTerm2row', 'Eliminerá <strong>tutte</strong> le sue note e le relazioni terminologiche. Queste azioni sono irreversibili!');
## v1.8
...
define('LABEL_eliminar', 'Eliminare');
##v.2
...
define('LABEL_altTerms', 'termini non preferiti');
define('LABEL_narrowerTerms', 'more specific terms');
define('LABEL_results', 'risultati');
...
#v.3.1
define('LABEL_noResults', 'Spiacenti, nessun risultato trovato');
...
#3.4
 ...
 #3.6.1
 define('LABEL_StatusVocab','vocabulary status');
 define('LABEL__STATUS_VOCAB_10','draft');
 define('LABEL__STATUS_VOCAB_20','candidate under review');
 define('LABEL__STATUS_VOCAB_30','experimental');
 define('LABEL__STATUS_VOCAB_40','historical - discontinued');
 define('LABEL__STATUS_VOCAB_50','published - stable');