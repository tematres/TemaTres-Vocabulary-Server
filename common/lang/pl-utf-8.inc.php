...
define("MSG_noUser","<p>Niezarejestrowany użytkownik</p>");
...
$install_message[201] = "Nie mogę odnaleźć pliku z konfiguracją połączenia do bazy danych (/include/db.tematres.php)." ;
$install_message[202] = "Znaleziono plik z konfiguracją połączenia do bazy danych." ;
$install_message[203] = "Nie udało się połączyć z serwerem bazy danych <em>%s</em> jako użytkownik <em>%s</em>. Proszę sprawdzić konfigurację (/include/db.tematres.php)." ;
$install_message[204] = "Pomyślnie nawiązano połączenie z serwerem <em>%s</em>" ;
$install_message[205] = "Nie udało się połączyć do bazy danych <em>%s</em> na serwerze <em>%s</em>. Proszę sprawdzić konfigurację (/include/db.tematres.php)." ;
$install_message[206] = "Pomyślnie nawiązano połączenie z bazą danych <em>%s</em> na serwerze <em>%s</em>." ;

$install_message[301] = "Ooppsss... Dla tej konfiguracji istnieje już instalacja TemaTres. Proszę sprawdzić konfigurację (/include/db.tematres.php)." ;
