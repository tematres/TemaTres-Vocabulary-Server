<?php
#   TemaTres : aplicacão de código aberto para gestão de línguas documentais #       #
#   Author for this i18n: Paulo Izidoro - pauloizidoro gmail.com
#   Distribuído sob a Licença Pública Geral GNU (GPLv2 de junho de 1991) - Free Software Foundation
#   Trad. pt-PT - Version 2.0 - 06/08/2018
#
###############################################################################################################
#
define("LANG","pt");
define("TR_acronimo","TR"); /*Termo relacionado*/
define("TE_acronimo","TE"); /*Termo específico*/
define("TG_acronimo","TG"); /*Termo genérico*/
define("UP_acronimo","UP"); /*Usado por, em vez de*/
...
define("MENU_AgregarUP","Termo não preferencial (UP)");
...
define("LABEL_terminosLibres","Termos livres"); /* 'Terme libre' usually refers to a term from the natural language, and thus not controlled. This is not exactly what 'termino libre' means in Tematres. Note: 'orphelin' (orphan) is not good either as it means 'not preferred' */
...
define("MSG_ResultCambios","Alterado com sucesso.");
...
define("LABEL_jeraquico","Poli-hierárquica");
...
define("EQ_acronimo","EQ"); /* equivalente */
define("EQP_acronimo","PEQ"); /* parcialmente equivalente */
define("NEQ_acronimo","NEQ"); /* não equivalente */
...
define("LABEL_siteMap","Mapa do sítio");
define("LABEL_TotalTopicMap","exportar para TopicMap");
/* v 1.0 */
define("LABEL_fecha_creacion","criado");
define("NB_acronimo","NB"); /* Nota bibliográfica */
define("NH_acronimo","NH"); /* Nota histórica */
define("NA_acronimo","NE"); /* Nota explicativa */
define("NP_acronimo","NP"); /* Note privada */
define("NC_acronimo","NC"); /* Note do catalogador */
...
define("LABEL_existAgregarUP","Adicionar termo não preferencial a %s");
...
$install_message[301] = 'Ooops... Já existe uma instância do Tematres para esta configuração. Verifique o ficheiro de configuração da ligação à base de dados (%s). <a href="index.php">Comece a utilizar o seu vocabulário</a>' ;
...
define("LABEL_dbMantenimiento","Base de dados");  /* menu entry. keep it short */ 
/*
v 1.2
*/
...
define('MSG__need2setup_endpoint','O ponto de consulta SPARQL precisa ser atualizado. Contacte o administrador do sistema');
...
##v.2
define('MSG_termsNoDeleted','os termos não foram excluídos');
...
define('LABEL_preferedTerms','termos preferenciais');
...
define('MSG__autoGlossInfo','Este proceso associa os termos existentes no vocabulário às suas menções nas notas. É utilizada a notação Wiki (Ex.: <i>Só o [[amor]] salvará o mundo</i>). Corresponde a uma operação de pesquisa e substituição de texto <strong>sensível a maiúsculas</strong>.');
...
define('MENU_glossConfig','Glossário automático'); /* menu entry. keep it short */ 
