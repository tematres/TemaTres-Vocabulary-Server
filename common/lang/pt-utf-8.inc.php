...
define('LABEL_FORM_nullValue','não importar');
...
define('FORM_LABEL__contactMail','e-mail');
...
define('LABEL_helpSearchFreeTerms','Somentes serão recuperados os termos livres.');
define('LABEL_broatherTerms','termos gerais');
define('LABEL_type2filter','digite para filtrar os termos');
define('LABEL_defaultEQmap','Utilize "eq" para indicar relação de equivalência');
define("MSG_repass_error","a senha não coincide");
define("MSG_lengh_error","mínimo de %d caracteres");
define("MSG_errorPostData","Ocorreu um erro, por favor revise os dados correspondente ao campo ");
define('LABEL_preferedTerms','termos preferidos');
define('LABEL_FORM_NULLnotesTermReport','termos SEM notas');
define('MSG_FORM_NULLnotesTermReport','termos que não possuem notas de tipo');
define('LABELnoNotes','termos sem nenhuma nota');
define('LABEL_termsXdeepLevel','termos segundo nível de profundidad');
define('LABEL_deepLevel','nível');
define('LABEL_cantTerms','# de termos');
define('LINK_publicKnownVocabularies','<a href="http://www.vocabularyserver.com/vocabularies/" title="Lista de vocabulários controlados conhecidos" target="_blank">Lista de vocabulários controlados conhecidos</a>');
define('LABEL_showNewsTerm','ver alterações recentes');
define('LABEL_newsTerm','alterações recentes');
define('MSG_contactAdmin','contate o administrador');
define('LABEL_addTargetVocabulary','adicionar vocabulários de refêrencia (web services terminológicos)');
#v.2.1
...
define('LABEL_termMOD','termos modificado');
define('LABEL_noteMOD','nota modificada');
define('MENU_bulkEdition','Alterações globais');
define('MSG_searchFor','texto que deseja substituir (sensível a maiúsculas)');
define('MSG_replaceWith','texto que substituirá (sensível a maiúsculas)');
define('LABEL_warningBulkEditor','Você irá modificar em lote os dados. Estas ações são IRREVERSÍVEIS!');
define('LABEL_CFG_SUGGESTxWORD','Permitir sugerir termos segundo palavras ou frases?');
define('LABEL_ALLOW_DUPLICATED','Será permitido termos duplicados?');
define('LABEL_CFG_PUBLISH','O vocabulário será público?');
...
define('LABEL_configGlossary','exportar fonte de dados para o glossário');
...
define('LABEL_opt_show_rando_term','apresentar termos com nota:');
define('MSG_helpNoteEditor','Pode vincular termos utilizando colchetes duplas. Ex: Somente o [[amor]] salvará o mundo');
define('LABEL_GLOSS_NOTES','Selecionar tipo de nota para glosar termos marcados com colchetes duplas: [[glosario]]');
