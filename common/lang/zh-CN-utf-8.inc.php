...
define('LABEL_enable', "可用e");  /* web services status info: in use */
define('LABEL_disable', "停用");  /* web services status info: not in use */
